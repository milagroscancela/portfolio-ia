...
![Rolling Mean vs Actual Cart Size](assets/temporal-features/temporal-rolling-mean-cart-size-2.png)
...
![Rolling vs Expanding Windows](assets/temporal-features/temporal-rolling-vs-expanding-2.png)
...
![Distribuciones RFM](assets/temporal-features/temporal-rfm-distributions-2.png)
...
![Comparación Time Windows](assets/temporal-features/temporal-time-windows-comparison-2.png)
...
![Product Diversity](assets/temporal-features/temporal-product-diversity-2.png)
